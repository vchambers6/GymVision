//
//  FrameProcessingChain.swift
//  GymVision
//
//  Created by Vanessa Chambers on 2/21/24.
//
// MARK: ALL OF THIS IS COPIED FROM THE APPLE DEVELOPER PROJECT
...
protocol FrameProcessingChainDelegate: AnyObject {
    ...
    func frameProcessingChain(_ chain: FrameProcessingChain,
...
class FrameProcessingChain {
    ...
    weak var delegate: FrameProcessingChainDelegate?
    ...
    private let actionClassifier = SkillClassifier.shared
...
extension FrameProcessingChain {
...
extension FrameProcessingChain {
    ...
    private func findPosesInFrame(_ frame: CGImage) -> [Pose]? {
        ...
        DispatchQueue.main.async {
            self.delegate?.frameProcessingChain(self, didDetect: poses, in: frame)
        }
